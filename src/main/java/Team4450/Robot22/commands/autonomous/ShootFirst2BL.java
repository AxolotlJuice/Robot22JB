 ...
 */
public class ShootFirst2BL extends CommandBase
{
	 ...
	 */
	public ShootFirst2BL(DriveBase subsystem, Chooter chooter, Channel channel, Pose2d startingPose, Pickup pickup) 
	{
	...
	public void initialize() 
	{
		...
		//rotate: 192 (clockwise) (194)
		command = new AutoRotate(driveBase, 0.3, 192, AutoDrive.Pid.on, AutoDrive.Heading.angle);
		commands.addCommands(command);

		//engage pickup
		command = new InstantCommand(pickup::toggleDeploy);

		//Drive: (x:9.773, y:3.269)
		//       (x:10.584, y:2.716) distance: 0.981595639762 m.
		command = new AutoDrive(driveBase, 0.5, 
								SRXMagneticEncoderRelative.getTicksForDistance(3.2204581357020996, DRIVE_WHEEL_DIAMETER),
